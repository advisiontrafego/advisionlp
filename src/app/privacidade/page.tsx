...
export const metadata: Metadata = {
  ...
  description:
    "Política de Privacidade da Advision - Agência de Tráfego Pago em Pouso Alegre. Saiba como coletamos, usamos e protegemos seus dados pessoais.",
  alternates: {
    canonical: "https://advisionagencia.com.br/privacidade",
  },
};
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <Link
          href="/"
          className="text-electric-500 hover:text-electric-600 mb-8 inline-block"
        >
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-foreground/80">
          ...
          <section>
            ...
            <p>
              A Advision ("nós", "nosso" ou "empresa") está comprometida em
              proteger a privacidade e os dados pessoais de nossos usuários e
            ...
            <p>
              Ao utilizar nosso site (advisionagencia.com.br) e nossos serviços,
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Dados da Empresa:</strong> Nome da empresa, CNPJ,
                segmento de atuação
              </li>
              <li>
                <strong>Dados de Comunicação:</strong> Mensagens enviadas
                através de formulários, WhatsApp ou e-mail
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Cookies:</strong> Informações armazenadas no seu
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Prestação de Serviços:</strong> Fornecer nossos serviços
                de gestão de tráfego pago e marketing digital
              </li>
              <li>
                <strong>Comunicação:</strong> Responder suas solicitações,
                enviar propostas comerciais e atualizações sobre nossos serviços
              </li>
              <li>
                <strong>Análise e Melhoria:</strong> Analisar o uso do site para
                melhorar nossos serviços e experiência do usuário
              </li>
              <li>
                <strong>Marketing:</strong> Enviar comunicações de marketing
                (com seu consentimento prévio)
              </li>
              <li>
                <strong>Cumprimento Legal:</strong> Cumprir obrigações legais e
                regulatórias
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Consentimento:</strong> Quando você nos fornece seus
                dados voluntariamente
              </li>
              <li>
                <strong>Execução de Contrato:</strong> Para prestação de nossos
                serviços
              </li>
              <li>
                <strong>Legítimo Interesse:</strong> Para análise de dados e
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Prestadores de Serviços:</strong> Google Ads, Meta Ads,
                TikTok Ads, ferramentas de análise e CRM
              </li>
              <li>
                <strong>WhatsApp:</strong> Para comunicação direta com você
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              destruição ou alteração. Isso inclui:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              e-mail: <strong>contato@advisionagencia.com.br</strong>
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              conhecimento de que coletamos dados de um menor, tomaremos medidas
          ...
          <section>
            ...
            <p>
              ...
              nosso site ou por e-mail. A data da última atualização será sempre
          ...
          <section>
            ...
            <p>
              ...
              relacionados a esta Política de Privacidade, entre em contato:
            </p>
            <div className="bg-muted p-6 rounded-lg mt-4">
              <p>
                <strong>Advision - Agência de Tráfego Pago</strong>
              </p>
          ...
          <section>
            ...
            <p>
              Para questões específicas sobre proteção de dados, você pode
              entrar em contato com nosso Encarregado de Dados através do
              e-mail: <strong>dpo@advisionagencia.com.br</strong>
            </p>
          </section>
        </div>
