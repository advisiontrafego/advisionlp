...
const RotatingEarth = dynamic(() => import("@/components/OrbitLogos"), {
  loading: () => (
    <div className="flex justify-center items-center w-full h-full min-h-[300px] lg:min-h-[400px]" />
  ),
  ssr: false,
});
            ...
            <div className="grid lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
              <div className="text-center lg:text-left space-y-6 md:space-y-10">
                ...
                <p className="text-lg sm:text-xl md:text-2xl leading-relaxed text-gray-900 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0">
                  <strong>Tráfego pago</strong> e <strong>dados</strong> que
                  geram <strong>crescimento real</strong>. Campanhas otimizadas
                  para maximizar seu <strong>ROI</strong>.
                </p>
              ...
              <div
                className="flex justify-center items-center w-full overflow-visible py-8"
                aria-hidden="true"
              >
                <RotatingEarth />
              </div>
